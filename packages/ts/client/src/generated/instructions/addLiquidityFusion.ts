...
export const ADD_LIQUIDITY_FUSION_DISCRIMINATOR = new Uint8Array([
  186, 221, 60, 139, 153, 11, 193, 11,
]);

export function getAddLiquidityFusionDiscriminatorBytes() {
  return fixEncoderSize(getBytesEncoder(), 8).encode(
    ADD_LIQUIDITY_FUSION_DISCRIMINATOR
  );
}

export type AddLiquidityFusionInstruction<
...
export type AddLiquidityFusionInstructionData = {
...
export type AddLiquidityFusionInstructionDataArgs = {
...
export function getAddLiquidityFusionInstructionDataEncoder(): Encoder<AddLiquidityFusionInstructionDataArgs> {
  return transformEncoder(
    ...
    (value) => ({ ...value, discriminator: ADD_LIQUIDITY_FUSION_DISCRIMINATOR })
  );
}

export function getAddLiquidityFusionInstructionDataDecoder(): Decoder<AddLiquidityFusionInstructionData> {
...
export function getAddLiquidityFusionInstructionDataCodec(): Codec<
  AddLiquidityFusionInstructionDataArgs,
  AddLiquidityFusionInstructionData
> {
  return combineCodec(
    getAddLiquidityFusionInstructionDataEncoder(),
    getAddLiquidityFusionInstructionDataDecoder()
  );
}

export type AddLiquidityFusionInput<
...
> = {
  ...
  collateralA: AddLiquidityFusionInstructionDataArgs['collateralA'];
  collateralB: AddLiquidityFusionInstructionDataArgs['collateralB'];
  borrowA: AddLiquidityFusionInstructionDataArgs['borrowA'];
  borrowB: AddLiquidityFusionInstructionDataArgs['borrowB'];
  minAddedAmountA: AddLiquidityFusionInstructionDataArgs['minAddedAmountA'];
  minAddedAmountB: AddLiquidityFusionInstructionDataArgs['minAddedAmountB'];
  maxSwapSlippage: AddLiquidityFusionInstructionDataArgs['maxSwapSlippage'];
  remainingAccountsInfo: AddLiquidityFusionInstructionDataArgs['remainingAccountsInfo'];
};

export function getAddLiquidityFusionInstruction<
  TAccountAuthority extends string,
  TAccountTunaConfig extends string,
  TAccountMintA extends string,
  TAccountMintB extends string,
...
> {
  ...
  const instruction = {
    ...
    programAddress,
    data: getAddLiquidityFusionInstructionDataEncoder().encode(
      args as AddLiquidityFusionInstructionDataArgs
    ),
  } as AddLiquidityFusionInstruction<
    TProgramAddress,
    TAccountAuthority,
    TAccountTunaConfig,
    TAccountMintA,
...
export type ParsedAddLiquidityFusionInstruction<
  TProgram extends string = typeof TUNA_PROGRAM_ADDRESS,
...
> = {
  ...
  data: AddLiquidityFusionInstructionData;
};

export function parseAddLiquidityFusionInstruction<
...
>(
  instruction: IInstruction<TProgram> &
    ...
    IInstructionWithData<Uint8Array>
): ParsedAddLiquidityFusionInstruction<TProgram, TAccountMetas> {
  ...
  return {
    ...
    data: getAddLiquidityFusionInstructionDataDecoder().decode(
      instruction.data
    ),
  };
}
