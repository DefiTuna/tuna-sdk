...
export async function getTickArrayAddressFromTickIndex(whirlpool: Account<Whirlpool>, tickIndex: number) {
...
export async function getSwapTickArrayAddresses(whirlpool: Account<Whirlpool>): Promise<Address[]> {
