...
impl AddLiquidityFusion {
  pub fn instruction(&self, args: AddLiquidityFusionInstructionArgs) -> solana_program::instruction::Instruction {
    self.instruction_with_remaining_accounts(args, &[])
  }
  #[allow(clippy::arithmetic_side_effects)]
  #[allow(clippy::vec_init_then_push)]
  pub fn instruction_with_remaining_accounts(&self, args: AddLiquidityFusionInstructionArgs, remaining_accounts: &[solana_program::instruction::AccountMeta]) -> solana_program::instruction::Instruction {
    ...
    let mut data = borsh::to_vec(&AddLiquidityFusionInstructionData::new()).unwrap();
...
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
 pub struct AddLiquidityFusionInstructionData {
            discriminator: [u8; 8],
                                                      }

impl AddLiquidityFusionInstructionData {
  pub fn new() -> Self {
    Self {
                        discriminator: [186, 221, 60, 139, 153, 11, 193, 11],
                                                                                                                                  }
  }
}

impl Default for AddLiquidityFusionInstructionData {
  fn default() -> Self {
    Self::new()
  }
}
...
#[derive(BorshSerialize, BorshDeserialize, Clone, Debug, Eq, PartialEq)]
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
 pub struct AddLiquidityFusionInstructionArgs {
...
///
          ...
          ///   5. `[]` token_program_b
                ...
                ///   17. `[writable]` fee_recipient_ata_a
                ///   18. `[writable]` fee_recipient_ata_b
          ///   19. `[]` pyth_oracle_price_feed_a
          ///   20. `[]` pyth_oracle_price_feed_b
          ///   21. `[]` fusionamm_program
                ///   22. `[writable]` fusion_pool
                ///   23. `[writable]` fusion_position
          ///   24. `[]` memo_program
#[derive(Clone, Debug, Default)]
pub struct AddLiquidityFusionBuilder {
...
#[inline(always)]
  ...
  pub fn instruction(&self) -> solana_program::instruction::Instruction {
    let accounts = AddLiquidityFusion {
          ...
          let args = AddLiquidityFusionInstructionArgs {
  ...
  /// `add_liquidity_fusion` CPI accounts.
  pub struct AddLiquidityFusionCpiAccounts<'a, 'b> {
                  /// 
/// TUNA accounts
/// 
...
/// `add_liquidity_fusion` CPI instruction.
pub struct AddLiquidityFusionCpi<'a, 'b> {
...
/// 
    ...
    pub __args: AddLiquidityFusionInstructionArgs,
  }

impl<'a, 'b> AddLiquidityFusionCpi<'a, 'b> {
  pub fn new(
    program: &'b solana_program::account_info::AccountInfo<'a>,
          accounts: AddLiquidityFusionCpiAccounts<'a, 'b>,
...
/// Instruction builder for `AddLiquidityFusion` via CPI.
///
/// ### Accounts:
///
                      ///   0. `[writable, signer]` authority
          ...
          ///   24. `[]` memo_program
#[derive(Clone, Debug)]
pub struct AddLiquidityFusionCpiBuilder<'a, 'b> {
  instruction: Box<AddLiquidityFusionCpiBuilderInstruction<'a, 'b>>,
}

impl<'a, 'b> AddLiquidityFusionCpiBuilder<'a, 'b> {
  pub fn new(program: &'b solana_program::account_info::AccountInfo<'a>) -> Self {
    let instruction = Box::new(AddLiquidityFusionCpiBuilderInstruction {
      __program: program,
              authority: None,
              tuna_config: None,
              mint_a: None,
...
#[inline(always)]
  ...
  pub fn invoke_signed(&self, signers_seeds: &[&[&[u8]]]) -> solana_program::entrypoint::ProgramResult {
        ...
        let instruction = AddLiquidityFusionCpi {
...
#[derive(Clone, Debug)]
struct AddLiquidityFusionCpiBuilderInstruction<'a, 'b> {
