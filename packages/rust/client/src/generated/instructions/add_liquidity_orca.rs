...
impl AddLiquidityOrca {
  pub fn instruction(&self, args: AddLiquidityOrcaInstructionArgs) -> solana_program::instruction::Instruction {
    self.instruction_with_remaining_accounts(args, &[])
  }
  #[allow(clippy::arithmetic_side_effects)]
  #[allow(clippy::vec_init_then_push)]
  pub fn instruction_with_remaining_accounts(&self, args: AddLiquidityOrcaInstructionArgs, remaining_accounts: &[solana_program::instruction::AccountMeta]) -> solana_program::instruction::Instruction {
    ...
    let mut data = borsh::to_vec(&AddLiquidityOrcaInstructionData::new()).unwrap();
...
impl Default for AddLiquidityOrcaInstructionData {
  fn default() -> Self {
    Self::new()
  }
}
...
#[derive(BorshSerialize, BorshDeserialize, Clone, Debug, Eq, PartialEq)]
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
 pub struct AddLiquidityOrcaInstructionArgs {
...
/// Instruction builder for `AddLiquidityOrca`.
///
/// ### Accounts:
///
          ...
          ///   19. `[]` whirlpool_program
                ///   20. `[writable]` whirlpool
                ///   21. `[writable]` orca_position
          ///   22. `[]` token_program_a
          ///   23. `[]` token_program_b
          ///   24. `[]` memo_program
#[derive(Clone, Debug, Default)]
pub struct AddLiquidityOrcaBuilder {
...
#[inline(always)]
  ...
  pub fn instruction(&self) -> solana_program::instruction::Instruction {
    let accounts = AddLiquidityOrca {
          ...
          let args = AddLiquidityOrcaInstructionArgs {
  ...
  /// `add_liquidity_orca` CPI accounts.
  pub struct AddLiquidityOrcaCpiAccounts<'a, 'b> {
                  /// 
/// TUNA accounts
/// 
...
/// `add_liquidity_orca` CPI instruction.
pub struct AddLiquidityOrcaCpi<'a, 'b> {
...
/// 
    ...
    pub __args: AddLiquidityOrcaInstructionArgs,
  }

impl<'a, 'b> AddLiquidityOrcaCpi<'a, 'b> {
  pub fn new(
    program: &'b solana_program::account_info::AccountInfo<'a>,
          accounts: AddLiquidityOrcaCpiAccounts<'a, 'b>,
...
/// Instruction builder for `AddLiquidityOrca` via CPI.
///
/// ### Accounts:
///
                      ///   0. `[writable, signer]` authority
          ...
          ///   24. `[]` memo_program
#[derive(Clone, Debug)]
pub struct AddLiquidityOrcaCpiBuilder<'a, 'b> {
  instruction: Box<AddLiquidityOrcaCpiBuilderInstruction<'a, 'b>>,
}

impl<'a, 'b> AddLiquidityOrcaCpiBuilder<'a, 'b> {
  pub fn new(program: &'b solana_program::account_info::AccountInfo<'a>) -> Self {
    let instruction = Box::new(AddLiquidityOrcaCpiBuilderInstruction {
      __program: program,
              authority: None,
              tuna_config: None,
              mint_a: None,
...
#[derive(Clone, Debug)]
struct AddLiquidityOrcaCpiBuilderInstruction<'a, 'b> {
