...
/// Accounts.
#[derive(Debug)]
pub struct CollectAndCompoundFeesOrca {
            /// 
/// TUNA accounts
/// 
...
impl CollectAndCompoundFeesOrca {
  pub fn instruction(&self, args: CollectAndCompoundFeesOrcaInstructionArgs) -> solana_program::instruction::Instruction {
    self.instruction_with_remaining_accounts(args, &[])
  }
  #[allow(clippy::arithmetic_side_effects)]
  #[allow(clippy::vec_init_then_push)]
  pub fn instruction_with_remaining_accounts(&self, args: CollectAndCompoundFeesOrcaInstructionArgs, remaining_accounts: &[solana_program::instruction::AccountMeta]) -> solana_program::instruction::Instruction {
    ...
    let mut data = borsh::to_vec(&CollectAndCompoundFeesOrcaInstructionData::new()).unwrap();
...
impl Default for CollectAndCompoundFeesOrcaInstructionData {
  fn default() -> Self {
    Self::new()
  }
}
...
/// Instruction builder for `CollectAndCompoundFeesOrca`.
///
/// ### Accounts:
///
          ...
          ///   10. `[]` tuna_position_ata
                ///   11. `[writable]` tuna_position_ata_a
                ///   12. `[writable]` tuna_position_ata_b
                ///   13. `[writable]` fee_recipient_ata_a
                ///   14. `[writable]` fee_recipient_ata_b
...
pub struct CollectAndCompoundFeesOrcaBuilder {
...
impl CollectAndCompoundFeesOrcaBuilder {
  pub fn new() -> Self {
    Self::default()
  }
            /// 
...
#[inline(always)]
  ...
  pub fn instruction(&self) -> solana_program::instruction::Instruction {
    let accounts = CollectAndCompoundFeesOrca {
  ...
  /// `collect_and_compound_fees_orca` CPI accounts.
  pub struct CollectAndCompoundFeesOrcaCpiAccounts<'a, 'b> {
                  /// 
/// TUNA accounts
/// 
...
/// `collect_and_compound_fees_orca` CPI instruction.
pub struct CollectAndCompoundFeesOrcaCpi<'a, 'b> {
...
/// 
    ...
    pub __args: CollectAndCompoundFeesOrcaInstructionArgs,
  }

impl<'a, 'b> CollectAndCompoundFeesOrcaCpi<'a, 'b> {
  pub fn new(
    program: &'b solana_program::account_info::AccountInfo<'a>,
          accounts: CollectAndCompoundFeesOrcaCpiAccounts<'a, 'b>,
              args: CollectAndCompoundFeesOrcaInstructionArgs,
      ) -> Self {
    Self {
      __program: program,
...
/// Instruction builder for `CollectAndCompoundFeesOrca` via CPI.
///
/// ### Accounts:
///
                      ///   0. `[writable, signer]` authority
          ...
          ///   22. `[]` memo_program
#[derive(Clone, Debug)]
pub struct CollectAndCompoundFeesOrcaCpiBuilder<'a, 'b> {
  instruction: Box<CollectAndCompoundFeesOrcaCpiBuilderInstruction<'a, 'b>>,
}

impl<'a, 'b> CollectAndCompoundFeesOrcaCpiBuilder<'a, 'b> {
  pub fn new(program: &'b solana_program::account_info::AccountInfo<'a>) -> Self {
    let instruction = Box::new(CollectAndCompoundFeesOrcaCpiBuilderInstruction {
      __program: program,
              authority: None,
              tuna_config: None,
              mint_a: None,
...
#[derive(Clone, Debug)]
struct CollectAndCompoundFeesOrcaCpiBuilderInstruction<'a, 'b> {
