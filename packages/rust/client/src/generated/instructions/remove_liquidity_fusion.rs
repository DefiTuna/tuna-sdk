...
/// Accounts.
#[derive(Debug)]
pub struct RemoveLiquidityFusion {
            /// 
/// TUNA accounts
/// 
...
impl RemoveLiquidityFusion {
  pub fn instruction(&self, args: RemoveLiquidityFusionInstructionArgs) -> solana_program::instruction::Instruction {
    self.instruction_with_remaining_accounts(args, &[])
  }
  #[allow(clippy::arithmetic_side_effects)]
  #[allow(clippy::vec_init_then_push)]
  pub fn instruction_with_remaining_accounts(&self, args: RemoveLiquidityFusionInstructionArgs, remaining_accounts: &[solana_program::instruction::AccountMeta]) -> solana_program::instruction::Instruction {
    ...
    let mut data = borsh::to_vec(&RemoveLiquidityFusionInstructionData::new()).unwrap();
...
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
 pub struct RemoveLiquidityFusionInstructionData {
            discriminator: [u8; 8],
                                          }

impl RemoveLiquidityFusionInstructionData {
  pub fn new() -> Self {
    Self {
                        discriminator: [175, 74, 205, 238, 4, 123, 166, 35],
                                                                                                      }
  }
}

impl Default for RemoveLiquidityFusionInstructionData {
  fn default() -> Self {
    Self::new()
  }
}
...
#[derive(BorshSerialize, BorshDeserialize, Clone, Debug, Eq, PartialEq)]
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
 pub struct RemoveLiquidityFusionInstructionArgs {
...
/// Instruction builder for `RemoveLiquidityFusion`.
///
/// ### Accounts:
///
          ...
          ///   6. `[]` token_program_b
                ...
                ///   15. `[writable]` tuna_position_owner_ata_a
                ///   16. `[writable]` tuna_position_owner_ata_b
...
pub struct RemoveLiquidityFusionBuilder {
            authority: Option<solana_program::pubkey::Pubkey>,
                ...
                swap_to_token: Option<u8>,
                min_removed_amount_a: Option<u64>,
                min_removed_amount_b: Option<u64>,
                max_swap_slippage: Option<u32>,
                remaining_accounts_info: Option<RemainingAccountsInfo>,
        __remaining_accounts: Vec<solana_program::instruction::AccountMeta>,
}

impl RemoveLiquidityFusionBuilder {
  pub fn new() -> Self {
    Self::default()
  }
            /// 
...
#[inline(always)]
    ...
    pub fn memo_program(&mut self, memo_program: solana_program::pubkey::Pubkey) -> &mut Self {
      ...
      pub fn withdraw_percent(&mut self, withdraw_percent: u32) -> &mut Self {
        ...
        self
                ...
                #[inline(always)]
      pub fn swap_to_token(&mut self, swap_to_token: u8) -> &mut Self {
        self.swap_to_token = Some(swap_to_token);
        self
      }
                #[inline(always)]
      pub fn min_removed_amount_a(&mut self, min_removed_amount_a: u64) -> &mut Self {
        self.min_removed_amount_a = Some(min_removed_amount_a);
        self
      }
                #[inline(always)]
      pub fn min_removed_amount_b(&mut self, min_removed_amount_b: u64) -> &mut Self {
        self.min_removed_amount_b = Some(min_removed_amount_b);
        self
      }
                #[inline(always)]
  ...
  pub fn instruction(&self) -> solana_program::instruction::Instruction {
    let accounts = RemoveLiquidityFusion {
          ...
          let args = RemoveLiquidityFusionInstructionArgs {
                                                              withdraw_percent: self.withdraw_percent.clone().expect("withdraw_percent is not set"),
                                                                  swap_to_token: self.swap_to_token.clone().expect("swap_to_token is not set"),
                                                                  min_removed_amount_a: self.min_removed_amount_a.clone().expect("min_removed_amount_a is not set"),
                                                                  min_removed_amount_b: self.min_removed_amount_b.clone().expect("min_removed_amount_b is not set"),
  ...
  /// `remove_liquidity_fusion` CPI accounts.
  pub struct RemoveLiquidityFusionCpiAccounts<'a, 'b> {
                  /// 
/// TUNA accounts
/// 
...
/// `remove_liquidity_fusion` CPI instruction.
pub struct RemoveLiquidityFusionCpi<'a, 'b> {
...
/// 
    ...
    pub __args: RemoveLiquidityFusionInstructionArgs,
  }

impl<'a, 'b> RemoveLiquidityFusionCpi<'a, 'b> {
  pub fn new(
    program: &'b solana_program::account_info::AccountInfo<'a>,
          accounts: RemoveLiquidityFusionCpiAccounts<'a, 'b>,
...
/// Instruction builder for `RemoveLiquidityFusion` via CPI.
///
/// ### Accounts:
///
                      ///   0. `[writable, signer]` authority
          ...
          ///   22. `[]` memo_program
#[derive(Clone, Debug)]
pub struct RemoveLiquidityFusionCpiBuilder<'a, 'b> {
  instruction: Box<RemoveLiquidityFusionCpiBuilderInstruction<'a, 'b>>,
}

impl<'a, 'b> RemoveLiquidityFusionCpiBuilder<'a, 'b> {
  pub fn new(program: &'b solana_program::account_info::AccountInfo<'a>) -> Self {
    let instruction = Box::new(RemoveLiquidityFusionCpiBuilderInstruction {
      __program: program,
              authority: None,
              tuna_config: None,
              market: None,
              ...
              memo_program: None,
                                ...
                                swap_to_token: None,
                                min_removed_amount_a: None,
                                min_removed_amount_b: None,
    ...
    pub fn memo_program(&mut self, memo_program: &'b solana_program::account_info::AccountInfo<'a>) -> &mut Self {
      ...
      pub fn withdraw_percent(&mut self, withdraw_percent: u32) -> &mut Self {
        ...
        self
                ...
                #[inline(always)]
      pub fn swap_to_token(&mut self, swap_to_token: u8) -> &mut Self {
        self.instruction.swap_to_token = Some(swap_to_token);
        self
      }
                #[inline(always)]
      pub fn min_removed_amount_a(&mut self, min_removed_amount_a: u64) -> &mut Self {
        self.instruction.min_removed_amount_a = Some(min_removed_amount_a);
        self
      }
                #[inline(always)]
      pub fn min_removed_amount_b(&mut self, min_removed_amount_b: u64) -> &mut Self {
        self.instruction.min_removed_amount_b = Some(min_removed_amount_b);
        self
      }
                #[inline(always)]
      pub fn max_swap_slippage(&mut self, max_swap_slippage: u32) -> &mut Self {
  ...
  pub fn invoke_signed(&self, signers_seeds: &[&[&[u8]]]) -> solana_program::entrypoint::ProgramResult {
          let args = RemoveLiquidityFusionInstructionArgs {
                                                              withdraw_percent: self.instruction.withdraw_percent.clone().expect("withdraw_percent is not set"),
                                                                  swap_to_token: self.instruction.swap_to_token.clone().expect("swap_to_token is not set"),
                                                                  min_removed_amount_a: self.instruction.min_removed_amount_a.clone().expect("min_removed_amount_a is not set"),
                                                                  min_removed_amount_b: self.instruction.min_removed_amount_b.clone().expect("min_removed_amount_b is not set"),
        ...
        let instruction = RemoveLiquidityFusionCpi {
...
#[derive(Clone, Debug)]
struct RemoveLiquidityFusionCpiBuilderInstruction<'a, 'b> {
