...
impl CollectFeesFusion {
  pub fn instruction(&self, args: CollectFeesFusionInstructionArgs) -> solana_program::instruction::Instruction {
    self.instruction_with_remaining_accounts(args, &[])
  }
  #[allow(clippy::arithmetic_side_effects)]
  #[allow(clippy::vec_init_then_push)]
  pub fn instruction_with_remaining_accounts(&self, args: CollectFeesFusionInstructionArgs, remaining_accounts: &[solana_program::instruction::AccountMeta]) -> solana_program::instruction::Instruction {
    ...
    let mut data = borsh::to_vec(&CollectFeesFusionInstructionData::new()).unwrap();
...
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
 pub struct CollectFeesFusionInstructionData {
            discriminator: [u8; 8],
            }

impl CollectFeesFusionInstructionData {
  pub fn new() -> Self {
    Self {
                        discriminator: [52, 219, 25, 250, 31, 203, 9, 129],
                                }
  }
}

impl Default for CollectFeesFusionInstructionData {
  fn default() -> Self {
    Self::new()
  }
}
...
#[derive(BorshSerialize, BorshDeserialize, Clone, Debug, Eq, PartialEq)]
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
 pub struct CollectFeesFusionInstructionArgs {
                  pub remaining_accounts_info: RemainingAccountsInfo,
      }


/// Instruction builder for `CollectFeesFusion`.
///
/// ### Accounts:
///
          ...
          ///   7. `[]` tuna_position_ata
                ...
                ///   10. `[writable]` tuna_position_owner_ata_a
                ///   11. `[writable]` tuna_position_owner_ata_b
          ///   12. `[]` fusionamm_program
                ///   13. `[writable]` fusion_pool
                ///   14. `[writable]` fusion_position
          ///   15. `[]` memo_program
#[derive(Clone, Debug, Default)]
pub struct CollectFeesFusionBuilder {
...
#[inline(always)]
  ...
  pub fn instruction(&self) -> solana_program::instruction::Instruction {
    let accounts = CollectFeesFusion {
          ...
          let args = CollectFeesFusionInstructionArgs {
  ...
  /// `collect_fees_fusion` CPI accounts.
  pub struct CollectFeesFusionCpiAccounts<'a, 'b> {
                  /// 
/// TUNA accounts
/// 
...
/// `collect_fees_fusion` CPI instruction.
pub struct CollectFeesFusionCpi<'a, 'b> {
...
/// 
    ...
    pub __args: CollectFeesFusionInstructionArgs,
  }

impl<'a, 'b> CollectFeesFusionCpi<'a, 'b> {
  pub fn new(
    program: &'b solana_program::account_info::AccountInfo<'a>,
          accounts: CollectFeesFusionCpiAccounts<'a, 'b>,
              args: CollectFeesFusionInstructionArgs,
      ) -> Self {
    Self {
      __program: program,
...
/// Instruction builder for `CollectFeesFusion` via CPI.
///
/// ### Accounts:
///
                      ///   0. `[writable, signer]` authority
          ...
          ///   15. `[]` memo_program
#[derive(Clone, Debug)]
pub struct CollectFeesFusionCpiBuilder<'a, 'b> {
  instruction: Box<CollectFeesFusionCpiBuilderInstruction<'a, 'b>>,
}

impl<'a, 'b> CollectFeesFusionCpiBuilder<'a, 'b> {
  pub fn new(program: &'b solana_program::account_info::AccountInfo<'a>) -> Self {
    let instruction = Box::new(CollectFeesFusionCpiBuilderInstruction {
      __program: program,
              authority: None,
              tuna_config: None,
              mint_a: None,
...
#[inline(always)]
  ...
  pub fn invoke_signed(&self, signers_seeds: &[&[&[u8]]]) -> solana_program::entrypoint::ProgramResult {
        ...
        let instruction = CollectFeesFusionCpi {
...
#[derive(Clone, Debug)]
struct CollectFeesFusionCpiBuilderInstruction<'a, 'b> {
