...
/// Accounts.
#[derive(Debug)]
pub struct LiquidatePositionFusion {
            /// 
/// TUNA accounts
/// 
...
impl LiquidatePositionFusion {
  pub fn instruction(&self, args: LiquidatePositionFusionInstructionArgs) -> solana_program::instruction::Instruction {
    self.instruction_with_remaining_accounts(args, &[])
  }
  #[allow(clippy::arithmetic_side_effects)]
  #[allow(clippy::vec_init_then_push)]
  pub fn instruction_with_remaining_accounts(&self, args: LiquidatePositionFusionInstructionArgs, remaining_accounts: &[solana_program::instruction::AccountMeta]) -> solana_program::instruction::Instruction {
    ...
    let mut data = borsh::to_vec(&LiquidatePositionFusionInstructionData::new()).unwrap();
...
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
 pub struct LiquidatePositionFusionInstructionData {
            discriminator: [u8; 8],
                  }

impl LiquidatePositionFusionInstructionData {
  pub fn new() -> Self {
    Self {
                        discriminator: [57, 160, 162, 122, 114, 173, 138, 220],
                                              }
  }
}

impl Default for LiquidatePositionFusionInstructionData {
  fn default() -> Self {
    Self::new()
  }
}
...
#[derive(BorshSerialize, BorshDeserialize, Clone, Debug, Eq, PartialEq)]
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
 pub struct LiquidatePositionFusionInstructionArgs {
                  pub withdraw_percent: u32,
                pub remaining_accounts_info: RemainingAccountsInfo,
      }


/// Instruction builder for `LiquidatePositionFusion`.
///
/// ### Accounts:
///
          ...
          ///   5. `[]` token_program_b
                ...
                ///   12. `[writable]` tuna_position_ata
                ///   13. `[writable]` tuna_position_ata_a
                ///   14. `[writable]` tuna_position_ata_b
                ///   15. `[writable]` liquidation_fee_recipient_ata_a
                ///   16. `[writable]` liquidation_fee_recipient_ata_b
          ///   17. `[]` pyth_oracle_price_feed_a
          ///   18. `[]` pyth_oracle_price_feed_b
          ///   19. `[]` fusionamm_program
                ///   20. `[writable]` fusion_pool
                ///   21. `[writable]` fusion_position
          ///   22. `[]` memo_program
#[derive(Clone, Debug, Default)]
pub struct LiquidatePositionFusionBuilder {
...
impl LiquidatePositionFusionBuilder {
  pub fn new() -> Self {
    Self::default()
  }
            /// 
...
#[inline(always)]
  ...
  pub fn instruction(&self) -> solana_program::instruction::Instruction {
    let accounts = LiquidatePositionFusion {
          ...
          let args = LiquidatePositionFusionInstructionArgs {
  ...
  /// `liquidate_position_fusion` CPI accounts.
  pub struct LiquidatePositionFusionCpiAccounts<'a, 'b> {
                  /// 
/// TUNA accounts
/// 
...
/// `liquidate_position_fusion` CPI instruction.
pub struct LiquidatePositionFusionCpi<'a, 'b> {
...
/// 
    ...
    pub __args: LiquidatePositionFusionInstructionArgs,
  }

impl<'a, 'b> LiquidatePositionFusionCpi<'a, 'b> {
  pub fn new(
    program: &'b solana_program::account_info::AccountInfo<'a>,
          accounts: LiquidatePositionFusionCpiAccounts<'a, 'b>,
              args: LiquidatePositionFusionInstructionArgs,
      ) -> Self {
    Self {
      __program: program,
...
/// Instruction builder for `LiquidatePositionFusion` via CPI.
///
/// ### Accounts:
///
                      ///   0. `[writable, signer]` authority
          ...
          ///   22. `[]` memo_program
#[derive(Clone, Debug)]
pub struct LiquidatePositionFusionCpiBuilder<'a, 'b> {
  instruction: Box<LiquidatePositionFusionCpiBuilderInstruction<'a, 'b>>,
}

impl<'a, 'b> LiquidatePositionFusionCpiBuilder<'a, 'b> {
  pub fn new(program: &'b solana_program::account_info::AccountInfo<'a>) -> Self {
    let instruction = Box::new(LiquidatePositionFusionCpiBuilderInstruction {
      __program: program,
              authority: None,
              tuna_config: None,
              mint_a: None,
...
#[inline(always)]
  ...
  pub fn invoke_signed(&self, signers_seeds: &[&[&[u8]]]) -> solana_program::entrypoint::ProgramResult {
        ...
        let instruction = LiquidatePositionFusionCpi {
...
#[derive(Clone, Debug)]
struct LiquidatePositionFusionCpiBuilderInstruction<'a, 'b> {
