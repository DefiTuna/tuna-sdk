...
/// Accounts.
#[derive(Debug)]
pub struct RemoveLiquidityOrca {
            /// 
/// TUNA accounts
/// 
...
impl RemoveLiquidityOrca {
  pub fn instruction(&self, args: RemoveLiquidityOrcaInstructionArgs) -> solana_program::instruction::Instruction {
    self.instruction_with_remaining_accounts(args, &[])
  }
  #[allow(clippy::arithmetic_side_effects)]
  #[allow(clippy::vec_init_then_push)]
  pub fn instruction_with_remaining_accounts(&self, args: RemoveLiquidityOrcaInstructionArgs, remaining_accounts: &[solana_program::instruction::AccountMeta]) -> solana_program::instruction::Instruction {
    ...
    let mut data = borsh::to_vec(&RemoveLiquidityOrcaInstructionData::new()).unwrap();
...
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
 pub struct RemoveLiquidityOrcaInstructionData {
            discriminator: [u8; 8],
                                          }

impl RemoveLiquidityOrcaInstructionData {
  pub fn new() -> Self {
    Self {
                        discriminator: [30, 69, 45, 170, 183, 195, 12, 119],
                                                                                                      }
  }
}

impl Default for RemoveLiquidityOrcaInstructionData {
  fn default() -> Self {
    Self::new()
  }
}
...
#[derive(BorshSerialize, BorshDeserialize, Clone, Debug, Eq, PartialEq)]
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
 pub struct RemoveLiquidityOrcaInstructionArgs {
...
/// Instruction builder for `RemoveLiquidityOrca`.
///
/// ### Accounts:
///
          ...
          ///   4. `[]` mint_b
                ...
                ///   13. `[writable]` tuna_position_owner_ata_a
                ///   14. `[writable]` tuna_position_owner_ata_b
...
pub struct RemoveLiquidityOrcaBuilder {
...
impl RemoveLiquidityOrcaBuilder {
  pub fn new() -> Self {
    Self::default()
  }
            /// 
...
#[inline(always)]
  ...
  pub fn instruction(&self) -> solana_program::instruction::Instruction {
    let accounts = RemoveLiquidityOrca {
  ...
  /// `remove_liquidity_orca` CPI accounts.
  pub struct RemoveLiquidityOrcaCpiAccounts<'a, 'b> {
                  /// 
/// TUNA accounts
/// 
...
/// `remove_liquidity_orca` CPI instruction.
pub struct RemoveLiquidityOrcaCpi<'a, 'b> {
...
/// 
    ...
    pub __args: RemoveLiquidityOrcaInstructionArgs,
  }

impl<'a, 'b> RemoveLiquidityOrcaCpi<'a, 'b> {
  pub fn new(
    program: &'b solana_program::account_info::AccountInfo<'a>,
          accounts: RemoveLiquidityOrcaCpiAccounts<'a, 'b>,
...
/// Instruction builder for `RemoveLiquidityOrca` via CPI.
///
/// ### Accounts:
///
                      ///   0. `[writable, signer]` authority
          ...
          ///   22. `[]` memo_program
#[derive(Clone, Debug)]
pub struct RemoveLiquidityOrcaCpiBuilder<'a, 'b> {
  instruction: Box<RemoveLiquidityOrcaCpiBuilderInstruction<'a, 'b>>,
}

impl<'a, 'b> RemoveLiquidityOrcaCpiBuilder<'a, 'b> {
  pub fn new(program: &'b solana_program::account_info::AccountInfo<'a>) -> Self {
    let instruction = Box::new(RemoveLiquidityOrcaCpiBuilderInstruction {
      __program: program,
              authority: None,
              tuna_config: None,
              market: None,
...
#[inline(always)]
  ...
  pub fn invoke_signed(&self, signers_seeds: &[&[&[u8]]]) -> solana_program::entrypoint::ProgramResult {
        ...
        let instruction = RemoveLiquidityOrcaCpi {
...
#[derive(Clone, Debug)]
struct RemoveLiquidityOrcaCpiBuilderInstruction<'a, 'b> {
