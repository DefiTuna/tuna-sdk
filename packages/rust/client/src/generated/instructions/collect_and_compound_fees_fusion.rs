...
/// Accounts.
#[derive(Debug)]
pub struct CollectAndCompoundFeesFusion {
            /// 
/// TUNA accounts
/// 
...
impl CollectAndCompoundFeesFusion {
  pub fn instruction(&self, args: CollectAndCompoundFeesFusionInstructionArgs) -> solana_program::instruction::Instruction {
    self.instruction_with_remaining_accounts(args, &[])
  }
  #[allow(clippy::arithmetic_side_effects)]
  #[allow(clippy::vec_init_then_push)]
  pub fn instruction_with_remaining_accounts(&self, args: CollectAndCompoundFeesFusionInstructionArgs, remaining_accounts: &[solana_program::instruction::AccountMeta]) -> solana_program::instruction::Instruction {
    ...
    let mut data = borsh::to_vec(&CollectAndCompoundFeesFusionInstructionData::new()).unwrap();
...
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
 pub struct CollectAndCompoundFeesFusionInstructionData {
            discriminator: [u8; 8],
                  }

impl CollectAndCompoundFeesFusionInstructionData {
  pub fn new() -> Self {
    Self {
                        discriminator: [61, 213, 30, 201, 89, 220, 156, 13],
                                              }
  }
}

impl Default for CollectAndCompoundFeesFusionInstructionData {
  fn default() -> Self {
    Self::new()
  }
}
...
#[derive(BorshSerialize, BorshDeserialize, Clone, Debug, Eq, PartialEq)]
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
 pub struct CollectAndCompoundFeesFusionInstructionArgs {
                  pub use_leverage: bool,
                pub remaining_accounts_info: RemainingAccountsInfo,
      }


/// Instruction builder for `CollectAndCompoundFeesFusion`.
///
/// ### Accounts:
///
          ...
          ///   12. `[]` tuna_position_ata
                ///   13. `[writable]` tuna_position_ata_a
                ///   14. `[writable]` tuna_position_ata_b
                ///   15. `[writable]` fee_recipient_ata_a
                ///   16. `[writable]` fee_recipient_ata_b
...
pub struct CollectAndCompoundFeesFusionBuilder {
...
impl CollectAndCompoundFeesFusionBuilder {
  pub fn new() -> Self {
    Self::default()
  }
            /// 
...
#[inline(always)]
  ...
  pub fn instruction(&self) -> solana_program::instruction::Instruction {
    let accounts = CollectAndCompoundFeesFusion {
          ...
          let args = CollectAndCompoundFeesFusionInstructionArgs {
  ...
  /// `collect_and_compound_fees_fusion` CPI accounts.
  pub struct CollectAndCompoundFeesFusionCpiAccounts<'a, 'b> {
                  /// 
/// TUNA accounts
/// 
...
/// `collect_and_compound_fees_fusion` CPI instruction.
pub struct CollectAndCompoundFeesFusionCpi<'a, 'b> {
...
/// 
    ...
    pub __args: CollectAndCompoundFeesFusionInstructionArgs,
  }

impl<'a, 'b> CollectAndCompoundFeesFusionCpi<'a, 'b> {
  pub fn new(
    program: &'b solana_program::account_info::AccountInfo<'a>,
          accounts: CollectAndCompoundFeesFusionCpiAccounts<'a, 'b>,
              args: CollectAndCompoundFeesFusionInstructionArgs,
      ) -> Self {
    Self {
      __program: program,
...
/// Instruction builder for `CollectAndCompoundFeesFusion` via CPI.
///
/// ### Accounts:
///
                      ///   0. `[writable, signer]` authority
          ...
          ///   22. `[]` memo_program
#[derive(Clone, Debug)]
pub struct CollectAndCompoundFeesFusionCpiBuilder<'a, 'b> {
  instruction: Box<CollectAndCompoundFeesFusionCpiBuilderInstruction<'a, 'b>>,
}

impl<'a, 'b> CollectAndCompoundFeesFusionCpiBuilder<'a, 'b> {
  pub fn new(program: &'b solana_program::account_info::AccountInfo<'a>) -> Self {
    let instruction = Box::new(CollectAndCompoundFeesFusionCpiBuilderInstruction {
      __program: program,
              authority: None,
              tuna_config: None,
              mint_a: None,
...
#[inline(always)]
  ...
  pub fn invoke_signed(&self, signers_seeds: &[&[&[u8]]]) -> solana_program::entrypoint::ProgramResult {
        ...
        let instruction = CollectAndCompoundFeesFusionCpi {
...
#[derive(Clone, Debug)]
struct CollectAndCompoundFeesFusionCpiBuilderInstruction<'a, 'b> {
