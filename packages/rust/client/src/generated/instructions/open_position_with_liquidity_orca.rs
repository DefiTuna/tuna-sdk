...
/// Accounts.
#[derive(Debug)]
pub struct OpenPositionWithLiquidityOrca {
            /// 
/// TUNA accounts
/// 
...
impl OpenPositionWithLiquidityOrca {
  pub fn instruction(&self, args: OpenPositionWithLiquidityOrcaInstructionArgs) -> solana_program::instruction::Instruction {
  ...
  pub fn instruction_with_remaining_accounts(&self, args: OpenPositionWithLiquidityOrcaInstructionArgs, remaining_accounts: &[solana_program::instruction::AccountMeta]) -> solana_program::instruction::Instruction {
    ...
    let mut data = borsh::to_vec(&OpenPositionWithLiquidityOrcaInstructionData::new()).unwrap();
...
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
 pub struct OpenPositionWithLiquidityOrcaInstructionData {
            discriminator: [u8; 8],
                                                                                    }

impl OpenPositionWithLiquidityOrcaInstructionData {
  pub fn new() -> Self {
    Self {
                        discriminator: [163, 21, 84, 199, 172, 40, 87, 122],
                                                                                                                                                                                                        }
  }
}

impl Default for OpenPositionWithLiquidityOrcaInstructionData {
  fn default() -> Self {
    Self::new()
  }
}
...
#[derive(BorshSerialize, BorshDeserialize, Clone, Debug, Eq, PartialEq)]
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
 pub struct OpenPositionWithLiquidityOrcaInstructionArgs {
...
/// Instruction builder for `OpenPositionWithLiquidityOrca`.
///
/// ### Accounts:
///
          ...
          ///   3. `[]` mint_b
                ...
                ///   9. `[writable]` tuna_position
                      ///   10. `[writable, signer]` tuna_position_mint
                ///   11. `[writable]` tuna_position_ata
                ///   12. `[writable]` tuna_position_ata_a
                ///   13. `[writable]` tuna_position_ata_b
                ///   14. `[writable]` tuna_position_owner_ata_a
                ///   15. `[writable]` tuna_position_owner_ata_b
                ///   16. `[writable]` fee_recipient_ata_a
                ///   17. `[writable]` fee_recipient_ata_b
          ///   18. `[]` pyth_oracle_price_feed_a
          ///   19. `[]` pyth_oracle_price_feed_b
          ///   20. `[]` whirlpool_program
                ///   21. `[writable]` whirlpool
                ///   22. `[writable]` orca_position
          ///   23. `[]` token_program_a
          ///   24. `[]` token_program_b
...
impl OpenPositionWithLiquidityOrcaBuilder {
  pub fn new() -> Self {
    Self::default()
  }
            /// 
...
#[inline(always)]
  ...
  pub fn instruction(&self) -> solana_program::instruction::Instruction {
    let accounts = OpenPositionWithLiquidityOrca {
  ...
  /// `open_position_with_liquidity_orca` CPI accounts.
  pub struct OpenPositionWithLiquidityOrcaCpiAccounts<'a, 'b> {
                  /// 
/// TUNA accounts
/// 
...
/// `open_position_with_liquidity_orca` CPI instruction.
pub struct OpenPositionWithLiquidityOrcaCpi<'a, 'b> {
...
/// 
    ...
    pub __args: OpenPositionWithLiquidityOrcaInstructionArgs,
  }

impl<'a, 'b> OpenPositionWithLiquidityOrcaCpi<'a, 'b> {
  pub fn new(
    program: &'b solana_program::account_info::AccountInfo<'a>,
          accounts: OpenPositionWithLiquidityOrcaCpiAccounts<'a, 'b>,
...
/// Instruction builder for `OpenPositionWithLiquidityOrca` via CPI.
///
/// ### Accounts:
///
                      ///   0. `[writable, signer]` authority
...
impl<'a, 'b> OpenPositionWithLiquidityOrcaCpiBuilder<'a, 'b> {
  pub fn new(program: &'b solana_program::account_info::AccountInfo<'a>) -> Self {
    let instruction = Box::new(OpenPositionWithLiquidityOrcaCpiBuilderInstruction {
      __program: program,
              authority: None,
              tuna_config: None,
              mint_a: None,
...
#[inline(always)]
  ...
  pub fn invoke_signed(&self, signers_seeds: &[&[&[u8]]]) -> solana_program::entrypoint::ProgramResult {
        ...
        let instruction = OpenPositionWithLiquidityOrcaCpi {
...
#[derive(Clone, Debug)]
struct OpenPositionWithLiquidityOrcaCpiBuilderInstruction<'a, 'b> {
