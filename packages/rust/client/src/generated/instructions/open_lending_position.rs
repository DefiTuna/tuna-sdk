...
/// Accounts.
#[derive(Debug)]
pub struct OpenLendingPosition {
...
impl OpenLendingPosition {
  ...
  pub fn instruction_with_remaining_accounts(&self, remaining_accounts: &[solana_program::instruction::AccountMeta]) -> solana_program::instruction::Instruction {
    ...
    let data = borsh::to_vec(&OpenLendingPositionInstructionData::new()).unwrap();
...
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
 pub struct OpenLendingPositionInstructionData {
            discriminator: [u8; 8],
      }

impl OpenLendingPositionInstructionData {
  pub fn new() -> Self {
    Self {
                        discriminator: [174, 227, 181, 127, 78, 227, 244, 19],
                  }
  }
}

impl Default for OpenLendingPositionInstructionData {
  fn default() -> Self {
    Self::new()
  }
}
...
/// Instruction builder for `OpenLendingPosition`.
///
/// ### Accounts:
///
...
impl OpenLendingPositionBuilder {
  pub fn new() -> Self {
    Self::default()
  }
            #[inline(always)]
...
#[inline(always)]
  ...
  pub fn instruction(&self) -> solana_program::instruction::Instruction {
    let accounts = OpenLendingPosition {
  ...
  /// `open_lending_position` CPI accounts.
  pub struct OpenLendingPositionCpiAccounts<'a, 'b> {
...
pub struct OpenLendingPositionCpi<'a, 'b> {
...
impl<'a, 'b> OpenLendingPositionCpi<'a, 'b> {
  pub fn new(
    program: &'b solana_program::account_info::AccountInfo<'a>,
          accounts: OpenLendingPositionCpiAccounts<'a, 'b>,
          ) -> Self {
    Self {
      __program: program,
...
/// Instruction builder for `OpenLendingPosition` via CPI.
///
/// ### Accounts:
///
                      ///   0. `[writable, signer]` authority
...
impl<'a, 'b> OpenLendingPositionCpiBuilder<'a, 'b> {
  pub fn new(program: &'b solana_program::account_info::AccountInfo<'a>) -> Self {
    let instruction = Box::new(OpenLendingPositionCpiBuilderInstruction {
      __program: program,
              authority: None,
              tuna_config: None,
              vault: None,
  ...
  #[allow(clippy::vec_init_then_push)]
  pub fn invoke_signed(&self, signers_seeds: &[&[&[u8]]]) -> solana_program::entrypoint::ProgramResult {
        let instruction = OpenLendingPositionCpi {
...
#[derive(Clone, Debug)]
struct OpenLendingPositionCpiBuilderInstruction<'a, 'b> {
