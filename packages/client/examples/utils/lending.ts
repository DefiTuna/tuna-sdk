import { Address, address, KeyPairSigner as _KeyPairSigner, Rpc, SolanaRpcApi } from "@solana/kit";
import { findAssociatedTokenPda, TOKEN_PROGRAM_ADDRESS } from "@solana-program/token";
import { getMintDecimals, loadKeypair } from "examples/utils/common";
import {
 ...
 */
export async function prepareLendingAccountsAndParameters(rpc: Rpc<SolanaRpcApi>) {
  /**
