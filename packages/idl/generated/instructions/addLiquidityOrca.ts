...
> = {
  ...
  accounts: {
    ...
    poolVaultAtaA: TAccountMetas[21];
    poolVaultAtaB: TAccountMetas[22];
    orcaPosition: TAccountMetas[23];
    tickArrayLower: TAccountMetas[24];
    tickArrayUpper: TAccountMetas[25];
    orcaOracle: TAccountMetas[26];
    /**
     *
     * Other accounts
     *
