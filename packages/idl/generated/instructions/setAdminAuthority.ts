...
export type SetAdminAuthorityInstruction<
...
export type SetAdminAuthorityInstructionData = {
  discriminator: ReadonlyUint8Array;
  adminAuthority: Address;
};

export type SetAdminAuthorityInstructionDataArgs = { adminAuthority: Address };
...
export function getSetAdminAuthorityInstructionDataCodec(): Codec<
  SetAdminAuthorityInstructionDataArgs,
  SetAdminAuthorityInstructionData
> {
  return combineCodec(
...
export type SetAdminAuthorityInput<
...
export type ParsedSetAdminAuthorityInstruction<
  TProgram extends string = typeof TUNA_PROGRAM_ADDRESS,
...
> = {
  ...
  data: SetAdminAuthorityInstructionData;
};

export function parseSetAdminAuthorityInstruction<
...
>(
  ...
  return {
    ...
    data: getSetAdminAuthorityInstructionDataDecoder().decode(instruction.data),
  };
}
