...
import {
  addLiquidityFusionInstructions,
  addLiquidityOrcaInstructions,
  COMPUTED_AMOUNT,
  fetchMarket,
  fetchTunaConfig,
  fetchTunaPosition,
...
export type AddLiquidityTestArgs = {
...
export type AddLiquidityTestResults = {
...
export type AddLiquidityTestExpectations = {
  userBalanceDeltaA?: bigint;
  userBalanceDeltaB?: bigint;
  vaultBalanceDeltaA?: bigint;
  vaultBalanceDeltaB?: bigint;
...
export function assertAddLiquidity(results: AddLiquidityTestResults, expectations: AddLiquidityTestExpectations) {
...
export async function addLiquidity({
  ...
  maxAmountSlippage,
  signer = FUNDER,
}: AddLiquidityTestArgs): Promise<AddLiquidityTestResults> {
  ...
  if (isOrcaMarket) {
    instructions.push(
      ...(await addLiquidityOrcaInstructions(
        rpc,
        signer,
        positionMint,
        addLiquidityArgs,
    ...
    instructions.push(
      ...(await addLiquidityFusionInstructions(
        rpc,
        signer,
        positionMint,
        addLiquidityArgs,
