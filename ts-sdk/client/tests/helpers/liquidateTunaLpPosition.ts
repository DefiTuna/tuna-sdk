...
import {
  ...
  HUNDRED_PERCENT,
  liquidateTunaLpPositionFusionInstructions,
...
export type LiquidateTunaLpPositionTestArgs = {
...
export type LiquidateTunaLpPositionTestExpectations = {
  vaultBalanceDeltaA?: bigint;
  vaultBalanceDeltaB?: bigint;
  poolBalanceDeltaA?: bigint;
  poolBalanceDeltaB?: bigint;
...
export function assertLiquidateTunaLpPosition(
  results: LiquidateTunaLpPositionTestResults,
  expectations: LiquidateTunaLpPositionTestExpectations,
) {
...
export async function liquidateTunaLpPosition({
  rpc,
  signer,
  positionMint,
  decreasePercent,
  ...
  if (market.data.marketMaker == MarketMaker.Orca) {
    instructions = await liquidateTunaLpPositionOrcaInstructions(
      signer,
      tunaPosition,
      tunaConfig,
      mintA,
