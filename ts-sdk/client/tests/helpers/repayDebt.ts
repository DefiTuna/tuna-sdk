...
import { fetchTunaPosition, getLendingVaultAddress, getTunaPositionAddress, repayDebtInstructions } from "../../src";
...
export async function repayDebt({ rpc, positionMint, collateralA, collateralB, signer = FUNDER }: RepayDebtTestArgs) {
  ...
  instructions.push(...(await repayDebtInstructions(rpc, signer, positionMint, collateralA, collateralB)));
