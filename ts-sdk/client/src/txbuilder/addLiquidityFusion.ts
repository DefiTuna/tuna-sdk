...
export type AddLiquidityFusionInstructionsArgs = Omit<
  AddLiquidityFusionInstructionDataArgs,
...
export async function addLiquidityFusionInstructions(
  ...
  args: AddLiquidityFusionInstructionsArgs,
...
export async function addLiquidityFusionInstruction(
  ...
  args: Omit<AddLiquidityFusionInstructionDataArgs, "remainingAccountsInfo">,
): Promise<IInstruction> {
