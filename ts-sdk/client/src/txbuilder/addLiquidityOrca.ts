...
export type AddLiquidityOrcaInstructionsArgs = Omit<
  AddLiquidityOrcaInstructionDataArgs,
...
export async function addLiquidityOrcaInstructions(
  ...
  args: AddLiquidityOrcaInstructionsArgs,
...
export async function addLiquidityOrcaInstruction(
  ...
  args: Omit<AddLiquidityOrcaInstructionDataArgs, "remainingAccountsInfo">,
): Promise<IInstruction> {
