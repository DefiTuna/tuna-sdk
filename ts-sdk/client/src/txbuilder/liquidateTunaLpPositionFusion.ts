...
export async function liquidateTunaLpPositionFusionInstructions(
  ...
  const ix = await liquidateTunaLpPositionFusionInstruction(
    authority,
    tunaPosition,
    tunaConfig,
    mintA,
...
export async function liquidateTunaLpPositionFusionInstruction(
  authority: TransactionSigner,
  tunaPosition: Account<TunaLpPosition>,
  tunaConfig: Account<TunaConfig>,
  mintA: Account<Mint>,
  ...
  const ix = getLiquidateTunaLpPositionFusionInstruction({
