...
export async function decreaseTunaLpPositionOrcaInstructions(
  ...
  args: DecreaseTunaLpPositionOrcaInstructionsArgs,
...
export async function decreaseTunaLpPositionOrcaInstruction(
  authority: TransactionSigner,
  ...
  const ix = getDecreaseTunaLpPositionOrcaInstruction({
