...
import {
  ...
  getLiquidateTunaLpPositionOrcaInstruction,
  getMarketAddress,
  OrcaUtils,
  TunaConfig,
  TunaLpPosition,
...
export async function liquidateTunaLpPositionOrcaInstructions(
...
export async function liquidateTunaLpPositionOrcaInstruction(
  authority: TransactionSigner,
  tunaPosition: Account<TunaLpPosition>,
  tunaConfig: Account<TunaConfig>,
  mintA: Account<Mint>,
  ...
  const ix = getLiquidateTunaLpPositionOrcaInstruction({
