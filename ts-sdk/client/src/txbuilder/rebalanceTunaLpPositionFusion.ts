...
export type RebalanceTunaLpPositionFusion = {
...
export async function rebalanceTunaLpPositionFusionInstructions(
  rpc: Rpc<GetAccountInfoApi & GetMultipleAccountsApi>,
  authority: TransactionSigner,
  positionMint: Address,
  createInstructions?: IInstruction[],
  cleanupInstructions?: IInstruction[],
): Promise<RebalanceTunaLpPositionFusion> {
  ...
  const ix = await rebalanceTunaLpPositionFusionInstruction(
    authority,
    tunaPosition,
    tunaConfig,
    mintA,
...
export async function rebalanceTunaLpPositionFusionInstruction(
  authority: TransactionSigner,
  ...
  const ix = getRebalanceTunaLpPositionFusionInstruction({
