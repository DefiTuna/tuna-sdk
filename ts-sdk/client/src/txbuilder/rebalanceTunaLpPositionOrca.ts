...
export type RebalanceTunaLpPositionOrca = {
...
export async function rebalanceTunaLpPositionOrcaInstructions(
  rpc: Rpc<GetAccountInfoApi & GetMultipleAccountsApi>,
  authority: TransactionSigner,
  positionMint: Address,
  createInstructions?: IInstruction[],
  cleanupInstructions?: IInstruction[],
): Promise<RebalanceTunaLpPositionOrca> {
  ...
  const ix = await rebalanceTunaLpPositionOrcaInstruction(
    authority,
    tunaPosition,
    tunaConfig,
    mintA,
...
export async function rebalanceTunaLpPositionOrcaInstruction(
  authority: TransactionSigner,
  ...
  const ix = getRebalanceTunaLpPositionOrcaInstruction({
