...
import {
  ...
  getMarketAddress,
  getRemoveLiquidityFusionInstruction,
...
export type RemoveLiquidityFusionInstructionsArgs = Omit<
  RemoveLiquidityFusionInstructionDataArgs,
  "remainingAccountsInfo" | "minRemovedAmountA" | "minRemovedAmountB"
> & { maxAmountSlippage: number };

export async function removeLiquidityFusionInstructions(
  rpc: Rpc<GetAccountInfoApi & GetMultipleAccountsApi>,
  authority: TransactionSigner,
  positionMint: Address,
  args: RemoveLiquidityFusionInstructionsArgs,
...
export async function removeLiquidityFusionInstruction(
  authority: TransactionSigner,
  ...
  args: Omit<RemoveLiquidityFusionInstructionDataArgs, "remainingAccountsInfo">,
): Promise<IInstruction> {
