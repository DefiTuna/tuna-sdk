...
export async function increaseTunaLpPositionFusionInstructions(
  ...
  args: IncreaseTunaLpPositionFusionInstructionsArgs,
  ...
  const ix = await increaseTunaLpPositionFusionInstruction(
    authority,
    tunaPosition,
    tunaConfig,
    mintA,
...
export async function increaseTunaLpPositionFusionInstruction(
  authority: TransactionSigner,
