    ...
    fn test_open_add_remove_liquidity_and_close_position() {
        ...
        rt.block_on(async {
            ...
            ctx.send_transaction_with_signers(
                vec![open_position_orca_instruction(
                    &ctx.rpc,
                    &ctx.signer.pubkey(),
                    &position_mint.pubkey(),
                    &test_market.pool,
                    OpenPositionOrcaInstructionArgs {
            ...
            ctx.send_transaction(
                add_liquidity_orca_instructions(
                    &ctx.rpc,
                    &ctx.signer.pubkey(),
                    &position_mint.pubkey(),
                    AddLiquidityArgs {
            ...
            ctx.send_transaction(vec![close_position_orca_instruction(
                &ctx.signer.pubkey(),
                &tuna_position.data,
