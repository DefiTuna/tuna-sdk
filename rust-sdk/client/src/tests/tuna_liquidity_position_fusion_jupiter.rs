...
mod tests {
    ...
    use crate::{
        ...
        open_and_increase_tuna_lp_position_fusion_instructions, LiquidateTunaLpPositionJupiterArgs, OpenAndIncreaseTunaLpPositionArgs,
        HUNDRED_PERCENT, JUPITER_EVENT_AUTHORITY, JUPITER_PROGRAM_ID, LEVERAGE_ONE,
    };
