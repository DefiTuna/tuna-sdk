...
mod tests {
    ...
    fn test_open_close_position() {
        ...
        rt.block_on(async {
            ...
            ctx.send_transaction(
                increase_tuna_lp_position_fusion_instructions(
                    &ctx.rpc,
                    &ctx.signer.pubkey(),
                    &position_mint.pubkey(),
            ...
            ctx.send_transaction(
                decrease_tuna_lp_position_fusion_instructions(
                    &ctx.rpc,
                    &ctx.signer.pubkey(),
                    &position_mint.pubkey(),
            ...
            ctx.send_transaction(vec![close_tuna_lp_position_fusion_instruction(
                &ctx.signer.pubkey(),
                &tuna_position.data,
    ...
    fn test_open_position_with_liquidity_and_close_with_liquidity() {
        ...
        rt.block_on(async {
            ...
            ctx.send_transaction(
                close_active_tuna_lp_position_fusion_instructions(
                    &ctx.rpc,
                    &ctx.signer.pubkey(),
                    &ix.position_mint,
    ...
    fn test_rebalance_position() {
        ...
        rt.block_on(async {
            ...
            ctx.send_transaction(
                rebalance_tuna_lp_position_fusion_instructions(&ctx.rpc, &ctx.signer.pubkey(), &ix.position_mint)
                    .unwrap()
                    .instructions,
            )
            .unwrap();
