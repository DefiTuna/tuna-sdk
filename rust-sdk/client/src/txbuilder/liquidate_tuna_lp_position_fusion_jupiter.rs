...
use crate::{get_market_address, get_tuna_config_address, get_tuna_liquidity_position_address, JUPITER_PROGRAM_ID};
...
pub struct LiquidateTunaLpPositionJupiterArgs {
