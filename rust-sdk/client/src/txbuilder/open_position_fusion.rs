use crate::instructions::{OpenPositionFusion, OpenPositionFusionInstructionArgs};
use crate::{get_market_address, get_tuna_position_address};
...
pub fn open_position_fusion_instruction(
    rpc: &RpcClient,
    authority: &Pubkey,
    ...
    let ix_builder = OpenPositionFusion {
        authority: *authority,
