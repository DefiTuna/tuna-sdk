...
use crate::instructions::{DecreaseTunaLpPositionFusion, DecreaseTunaLpPositionFusionInstructionArgs};
...
use crate::{get_market_address, get_tuna_config_address, get_tuna_liquidity_position_address, get_vault_address, HUNDRED_PERCENT};
...
pub fn decrease_tuna_lp_position_fusion_instructions(
    rpc: &RpcClient,
    authority: &Pubkey,
...
pub fn decrease_tuna_lp_position_fusion_instruction(
    authority: &Pubkey,
    ...
    let ix_builder = DecreaseTunaLpPositionFusion {
        authority: *authority,
