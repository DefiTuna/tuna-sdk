...
pub fn liquidate_tuna_spot_position_fusion_instructions(
    authority: &Pubkey,
    ...
    instructions.push(liquidate_tuna_spot_position_fusion_instruction(
        authority,
        tuna_position,
        tuna_config,
        vault_a,
...
pub fn liquidate_tuna_spot_position_fusion_instruction(
    authority: &Pubkey,
    tuna_position: &TunaSpotPosition,
    tuna_config: &TunaConfig,
    vault_a: &Vault,
    ...
    let ix_builder = LiquidateTunaSpotPositionFusion {
        authority: *authority,
    ...
    ix_builder.instruction_with_remaining_accounts(
        LiquidateTunaSpotPositionFusionInstructionArgs {
