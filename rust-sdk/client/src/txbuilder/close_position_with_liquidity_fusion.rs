...
pub fn close_position_with_liquidity_fusion_instructions(
    rpc: &RpcClient,
    authority: &Pubkey,
    ...
    instructions.push(close_position_fusion_instruction(&authority, &tuna_position.data, &mint_a_account.owner, &mint_b_account.owner));
