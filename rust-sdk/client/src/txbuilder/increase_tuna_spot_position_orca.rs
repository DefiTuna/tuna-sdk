use crate::accounts::{fetch_all_vault, fetch_tuna_config, fetch_tuna_spot_position, TunaConfig, TunaSpotPosition, Vault};
use crate::instructions::{IncreaseTunaSpotPositionOrca, IncreaseTunaSpotPositionOrcaInstructionArgs};
...
use crate::{get_market_address, get_tuna_config_address, get_tuna_spot_position_address, get_vault_address, IncreaseTunaSpotPositionArgs};
...
pub fn increase_tuna_spot_position_orca_instructions(
    rpc: &RpcClient,
    authority: &Pubkey,
    ...
    instructions.push(increase_tuna_spot_position_orca_instruction(
        authority,
...
pub fn increase_tuna_spot_position_orca_instruction(
    authority: &Pubkey,
    ...
    let ix_builder = IncreaseTunaSpotPositionOrca {
        authority: *authority,
    ...
    ix_builder.instruction_with_remaining_accounts(
        IncreaseTunaSpotPositionOrcaInstructionArgs {
