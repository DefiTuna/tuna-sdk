...
use crate::instructions::{AddLiquidityFusion, AddLiquidityFusionInstructionArgs};
...
pub fn add_liquidity_fusion_instructions(
    rpc: &RpcClient,
    authority: &Pubkey,
    ...
    instructions.push(add_liquidity_fusion_instruction(
        authority,
        &tuna_position.data,
        &tuna_config.data,
        &vault_a.data,
...
pub fn add_liquidity_fusion_instruction(
    authority: &Pubkey,
    ...
    let ix_builder = AddLiquidityFusion {
        authority: *authority,
    ...
    ix_builder.instruction_with_remaining_accounts(
        AddLiquidityFusionInstructionArgs {
