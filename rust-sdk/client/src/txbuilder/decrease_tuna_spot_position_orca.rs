...
use crate::instructions::{DecreaseTunaSpotPositionOrca, DecreaseTunaSpotPositionOrcaInstructionArgs};
...
use crate::{get_market_address, get_tuna_config_address, get_tuna_spot_position_address, get_vault_address, DecreaseTunaSpotPositionArgs};
...
pub fn decrease_tuna_spot_position_orca_instructions(
    rpc: &RpcClient,
    authority: &Pubkey,
    ...
    instructions.push(decrease_tuna_spot_position_orca_instruction(
        authority,
        &tuna_position.data,
        &vault_a.data,
        &vault_b.data,
...
pub fn decrease_tuna_spot_position_orca_instruction(
    authority: &Pubkey,
    ...
    let ix_builder = DecreaseTunaSpotPositionOrca {
        authority: *authority,
    ...
    ix_builder.instruction_with_remaining_accounts(
        DecreaseTunaSpotPositionOrcaInstructionArgs {
