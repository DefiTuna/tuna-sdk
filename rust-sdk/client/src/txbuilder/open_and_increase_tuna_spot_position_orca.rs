...
use crate::instructions::{OpenAndIncreaseTunaSpotPositionOrca, OpenAndIncreaseTunaSpotPositionOrcaInstructionArgs};
...
pub fn open_and_increase_tuna_spot_position_orca_instructions(
    rpc: &RpcClient,
    authority: &Pubkey,
...
pub fn open_and_increase_tuna_spot_position_orca_instruction(
    ...
    let ix_builder = OpenAndIncreaseTunaSpotPositionOrca {
        authority: *authority,
    ...
    ix_builder.instruction_with_remaining_accounts(
        OpenAndIncreaseTunaSpotPositionOrcaInstructionArgs {
